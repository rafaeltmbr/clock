...
## How to download
To download this project, you'll need **Git** to be installed (see [how to install Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git)), after that, open the terminal and run the following command
