...
\-- <b>label-input</b>    - Folder containing the whole label-input module
    \-- <b>build</b>      - Folder containing a standalone generated code to run this component individually
    \-- <b>dev</b>        - Folder containing a standalone source code to run this component individually
